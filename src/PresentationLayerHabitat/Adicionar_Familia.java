...
public class Adicionar_Familia extends javax.swing.JFrame {
    ...
    public Adicionar_Familia(Connection conn) {
        initComponents();
        this.daocffam = new DAOCFfamilia(conn);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            String rend = this.jTextField3.getText();
            String tel = this.jTextField2.getText();
            this.daocffam.put(rend,tel,bi);
