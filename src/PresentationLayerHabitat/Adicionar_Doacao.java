...
public class Adicionar_Doacao extends javax.swing.JFrame {
    ...
    public Adicionar_Doacao(Connection conn) {
        initComponents();
        this.daocafdon = new DAOCAFdonativo(conn);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Financeira", "Servico", "Material" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            String nif_doador = this.jTextField10.getText();
            String tipo = (String) this.jComboBox1.getSelectedItem();
            String nr_recibo = this.jTextField9.getText();
            String data_doacao = this.jTextField7.getText() + "-" + this.jTextField3.getText() + "-" + this.jTextField2.getText();
            if (data_doacao.equals("--"))
                data_doacao = null;
            String evento = "Nao";
            if (this.jCheckBox1.isSelected())
                evento = "Sim";
            String quantia = this.jTextField8.getText();
            String descricao = this.jTextField4.getText();
            String id_processo = this.jTextField6.getText();
            this.daocafdon.put(nif_doador, tipo, nr_recibo, data_doacao, evento, quantia, descricao, id_processo);
        } catch (SQLException ex) {
            Logger.getLogger(Adicionar_Doacao.class.getName()).log(Level.SEVERE, null, ex);
        }
